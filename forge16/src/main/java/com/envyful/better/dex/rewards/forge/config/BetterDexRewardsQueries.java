...
public class BetterDexRewardsQueries {
    ...
    public static final String CREATE_LOG_TABLE = "CREATE TABLE IF NOT EXISTS `better_dex_rewards_player_log`(" +
            "id             INT             UNSIGNED        NOT NULL        AUTO_INCREMENT," +
            "uuid           VARCHAR(64)     NOT NULL, " +
            "claimed_rank   VARCHAR(200)    NOT NULL, " +
    ...
    public static final String LOAD_LOGS_USER = "SELECT * FROM `better_dex_rewards_player_log` WHERE uuid = ?;";
